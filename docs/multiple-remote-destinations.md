...
> 
> Find more information on how to configure Rclone [here](https://github.com/userid0x0/repo-backup#configure-rclone-%EF%B8%8F-must-read-%EF%B8%8F).
...
With the above example, both remote destinations are available: `RepoBackup:/RepoBackup/` and `extraRemoteName1:extraRemoteDir1`.
